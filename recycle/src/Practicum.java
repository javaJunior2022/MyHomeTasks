    ...
    public static void main(String[] args) {
        ...
        switch (chatCommand) {
            ...
            case RECYCLABILITY:
                ...
                int recycleCode = scanner.nextInt();
                isRecycled(recycleCode);
                break;
            case BONUS:
                System.out.println("Введите количество вторсырья, кг:");
                double resource = scanner.nextDouble();
                double coefficient = 1;
                coefficient = (resource < 10) ? 10 : 15;
                double bonus = resource * coefficient;
                System.out.println("Количество бонусных баллов: " + bonus);
                break;


            default:
                throw new IllegalStateException("Unexpected value: " + chatCommand);
        }
